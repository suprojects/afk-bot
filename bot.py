...
def main():
	...
	from afk import AFK_HANDLER, AFK_MEDIA_HANDLER, AFK_MEDIA_OFF_HANDLER, AFK_GROUP, NO_AFK_GROUP, NO_AFK_HANDLER, AFK_REPLY_HANDLER, AFK_REPLY_GROUP
	...
	dispatcher.add_handler(AFK_MEDIA_OFF_HANDLER, AFK_GROUP)
